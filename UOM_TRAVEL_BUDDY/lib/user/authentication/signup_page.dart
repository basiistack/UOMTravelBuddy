...
import 'package:uom_travel_buddy/user/authentication/login_screen.dart';
...
class SingupPageU extends StatefulWidget {
  @override
  State<SingupPageU> createState() => _SingupPageState();
}

class _SingupPageState extends State<SingupPageU> {
              ...
              TextButton(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (c) => LoginScreenU()));
                  },
                  child: Text(
